...
\`ダメージボーナス\`…${getDB({ siz: characterData.abilities.siz.value, str: characterData.abilities.str.value })}　\`アイデア\`…${characterData.abilities.int.value * 5}　\`幸運\`…${characterData.abilities.pow.value * 5}　\`知識\`…${characterData.abilities.edu.value * 5}
`.trim()
		)
